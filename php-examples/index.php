...
<div id="content">
	...
	<?php include('mainmenu.inc'); ?>
        ...
        <div id="other-main">
          ...
          <p>This is a set of example PHP pages showing how to use the PHP example API. Each OneAPI function has its own page which allows a call to be made to the OneAPI server.</p>
          ...
          <li>The data returned to the application by the OneAPI server as a PHP object</li>
          </ul>
