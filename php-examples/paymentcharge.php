...
<?php
	...
	if (isset($_POST["callbackURL"])) $callbackURL=$_POST["callbackURL"];
	...
	if (!isset($submit)) {
		...
		$callbackURL="http://localhost/paymentchargenotification.php";
		...
		$endpoints->setAmountChargeEndpoint($endpoint);

		$charge = new Charge($endpoints, $username, $password);
	
		$paymentResponse=$charge->charge($endUserId, $referenceCode, $description, $currency, $amount, $code, $callbackURL, $clientCorrelator, 
	...
	<?php include("mainmenu.inc"); ?>
        ...
        <div id="other-main">
          ...
          <div class="other-bottom">
            <div class="left">
          <h3>
            Payment API - Charge Amount To End User's Bill
          </h3>
          <p>
      
		</p>
		
		<form method="post" action="paymentcharge.php">
			...
			<div class="ParameterRow">
				...
				<div class="ParameterValue"><textarea name="callbackURL" style="width:400px;height:80px;"><?php echo $callbackURL;?></textarea></div>
			</div>
			<div class="ParameterRow">
