...
<?php
	...
	if (!isset($submit)) {
		...
		$callbackURL="http://localhost/paymentchargereservednotification.php";
		...
		$endpoints->setAmountReservationChargeEndpoint($endpoint);

		$reservation = new Reservation($endpoints, $username, $password);
	
		$paymentResponse=$reservation->chargeAmount($endUserId, $referenceCode, $description, $currency, $amount, $referenceSequence, $code, $callbackURL, $clientCorrelator,
	...
	<?php include("mainmenu.inc"); ?>
        ...
        <div id="other-main">
          ...
          <div class="other-bottom">
            <div class="left">
          <h3>
            Payment API - Charge Reservation To End User's Bill
          </h3>
          <p>
      
		</p>
		
		<form method="post" action="paymentchargereserved.php">
