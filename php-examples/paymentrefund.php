...
<?php
	...
	$originalServerReferenceCode=null;
	$onBehalfOf=null;
	...
	if (isset($_POST["originalServerReferenceCode"])) $originalServerReferenceCode=$_POST["originalServerReferenceCode"];
	...
	if (!isset($submit)) {
		...
		$endpoints->setAmountRefundEndpoint($endpoint);

		$charge = new Charge($endpoints, $username, $password);
	
		$paymentResponse=$charge->refund($endUserId, $referenceCode, $description, $currency, $amount, $code, $clientCorrelator, $originalServerReferenceCode,
	...
	<?php include("mainmenu.inc"); ?>
        ...
        <div id="other-main">
          ...
          <div class="other-bottom">
            <div class="left">
          <h3>
            Payment API - Refund Amount To End User's Bill
          </h3>
          <p>
      
		</p>
		
		<form method="post" action="paymentrefund.php">
			...
			<div class="ParameterRow">
				...
				<div class="ParameterValue"><input type="text" name="originalServerReferenceCode" value="<?php echo $originalServerReferenceCode;?>"/></div>
			</div>
        ...
        <?php if (isset($paymentResponse)) { 
        	$amountTransaction=$paymentResponse->getAmountTransaction();
        	?>
			...
			<?php if (!is_null($paymentResponse->getRequestError())) { ?>
				...
				<?php } ?>
			<?php } ?>
			<?php if (isset($amountTransaction)) { ?>
          		<div class="ParameterGroupHeading"><strong>amountTransaction Response</strong></div>
	          	<div class="ParameterRow">
					<div class="ParameterLabel">clientCorrelator</div>
					<div class="ParameterValue"><?php echo $amountTransaction->getClientCorrelator();?></div>				
				</div>
	          	<div class="ParameterRow">
					<div class="ParameterLabel">endUserId</div>
					<div class="ParameterValue"><?php echo $amountTransaction->getEndUserId();?></div>				
				</div>
				<?php if ($amountTransaction->getPaymentAmount()) { ?>
					<?php if ($amountTransaction->getPaymentAmount()->getChargingInformation()) { ?>
			          	<div class="ParameterRow">
							<div class="ParameterLabel">paymentAmount.chargingInformation.amount</div>
							<div class="ParameterValue"><?php echo $amountTransaction->getPaymentAmount()->getChargingInformation()->getAmount();?></div>				
						</div>
			          	<div class="ParameterRow">
							<div class="ParameterLabel">paymentAmount.chargingInformation.currency</div>
							<div class="ParameterValue"><?php echo $amountTransaction->getPaymentAmount()->getChargingInformation()->getCurrency();?></div>				
						</div>
			          	<div class="ParameterRow">
							<div class="ParameterLabel">paymentAmount.chargingInformation.description</div>
							<div class="ParameterValue"><?php echo $amountTransaction->getPaymentAmount()->getChargingInformation()->getDescription();?></div>				
						</div>		
					<?php } ?>
		          	<div class="ParameterRow">
						<div class="ParameterLabel">paymentAmount.totalAmountCharged</div>
						<div class="ParameterValue"><?php echo $amountTransaction->getPaymentAmount()->getTotalAmountCharged();?></div>				
					</div>		
				<?php } ?>
	          	<div class="ParameterRow">
					<div class="ParameterLabel">referenceCode</div>
					<div class="ParameterValue"><?php echo $amountTransaction->getReferenceCode();?></div>				
				</div>
	          	<div class="ParameterRow">
					<div class="ParameterLabel">resourceURL</div>
					<div class="ParameterValue"><?php echo $amountTransaction->getResourceURL();?></div>				
				</div>
	          	<div class="ParameterRow">
					<div class="ParameterLabel">serverReferenceCode</div>
					<div class="ParameterValue"><?php echo $amountTransaction->getServerReferenceCode();?></div>				
				</div>
	          	<div class="ParameterRow">
					<div class="ParameterLabel">transactionOperationStatus</div>
					<div class="ParameterValue"><?php echo $amountTransaction->getTransactionOperationStatus();?></div>				
				</div>
			<?php }
			} ?>
