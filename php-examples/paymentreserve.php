...
<?php
	...
	if (!isset($submit)) {
		...
		$endpoints->setAmountReserveEndpoint($endpoint);

		$reservation = new Reservation($endpoints, $username, $password);
	
		$paymentResponse=$reservation->reserveInitialAmount($endUserId, $referenceCode, $description, $currency, $amount, $code, $clientCorrelator,
	...
	<?php include("mainmenu.inc"); ?>
        ...
        <div id="other-main">
          ...
          <div class="other-bottom">
            <div class="left">
          <h3>
            Payment API - Reserve Initial Payment Amount On End User's Bill
          </h3>
          <p>
      
		</p>
		
		<form method="post" action="paymentreserve.php">
