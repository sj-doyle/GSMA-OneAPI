...
class AmountReservationTransaction {
	...
	protected $referenceSequence=null;
	...
	public function getReferenceSequence() { return $this->referenceSequence; }
	...
	public function __construct($jsondata) {
		if (!is_null($jsondata)) {
			...
			if (property_exists($jsondata, 'referenceSequence')) {
				$this->referenceSequence = $jsondata->referenceSequence;
			}
		}
	}
