...
require_once($ONEAPICOMMON.'response/sms/InboundSMSMessageNotification.php');
...
class SMSRetrieve {
	...
	public static function convertInboundSMSMessageNotification($contentType, $requestBody) {
		$inboundSMSMessageNotification=null;
		if ($contentType && $contentType=="application/json") {
			$jsondata=json_decode($requestBody);
			if (property_exists($jsondata, 'inboundSMSMessageNotification')) {				
				$inboundSMSMessageNotification=new InboundSMSMessageNotification($jsondata->inboundSMSMessageNotification);
			}			
		}
