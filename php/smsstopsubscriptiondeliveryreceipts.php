	...
	<?php include("mainmenu.inc"); ?>
        ...
        <div id="other-main">
          ...
          <div class="other-bottom">
            <div class="left">
          <h3>
            Outbound SMS API - Cancel SMS Delivery Notifications Subscription
          </h3>
          <p>
      
		</p>
		
		<form method="post" action="smsstopsubscriptiondeliveryreceipts.php">
        ...
        <?php if (isset($smsResponse)) { ?>
          <h3>Response:</h3>
          	...
          	<div class="ParameterRow">
				...
				<div class="ParameterValue"><?php echo $smsResponse;?></div>
			</div>
		<?php } ?>
