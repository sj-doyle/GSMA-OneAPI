...
class AmountTransaction:
	"""class containing the payment details response received from the OneAPI server when a simple payment charge or refund is applied to the mobile user account"""
