...
/**
 * The full response from the OneAPI server for a request to subscribe to MMS Delivery Receipts
 */
public class MMSDeliveryReceiptSubscriptionResponse implements java.io.Serializable {
	private static final long serialVersionUID = -6897641669461218524L;
	...
	/** 
	 * generate a textual representation of the MMSDeliveryReceiptSubscriptionResponse instance including all nested elements and classes 
	 */
