...
public class SMSDeliveryReportSubscriptionServlet extends OneAPIServlet implements Runnable {
	...
	public SMSDeliveryReportSubscriptionServlet(String callbackData, String notifyURL) {
	...
	public void run() {
		...
		try {
			...
			deliveryInfoNotification.setDeliveryInfo(new DeliveryInfoNotification.DeliveryInfo[] {deliveryInfo1});
