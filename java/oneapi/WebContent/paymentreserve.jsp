...
<%
	...
	if (submit==null) {
		...
		username="Fred.Jones";
		password="1234";
		endpoint=sandboxEndpoints.getServiceEndpoints().getAmountReserveEndpoint();

	} else {
		sandboxEndpoints.setAmountReserve(endpoint);
		...
		paymentResponse=me.reserveInitialAmount(endUserId, referenceCode, description, currency, amount, code,
	...
	<%@ include file="mainmenu.inc" %>
        ...
        <div id="other-main">
          ...
          <div class="other-bottom">
            <div class="left">
          <h3>
            Payment API - Reserve Charge On End User's Bill
          </h3>
          <p>
      
		</p>
		
		<form method="post" action="paymentreserve.jsp">
          ...
          <h3>Response:</h3>
			...
			<% if (amountReservationTransaction!=null) { %>
	          	...
	          	<div class="ParameterRow">
					<div class="ParameterLabel">clientCorrelator</div>
					<div class="ParameterValue"><%=amountReservationTransaction.getClientCorrelator()%></div>				
				</div>
	          	<div class="ParameterRow">
					<div class="ParameterLabel">endUserId</div>
