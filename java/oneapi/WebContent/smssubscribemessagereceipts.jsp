...
<%@ page import="org.gsm.oneapi.responsebean.sms.SMSMessageReceiptSubscriptionResponse"%>
...
<%
	...
	SMSMessageReceiptSubscriptionResponse smsResponse=null;
	...
	if (submit==null) {
		...
		username="Fred.Jones";
		password="1234";
		endpoint=sandboxEndpoints.getServiceEndpoints().getSMSReceiptSubscriptionsEndpoint();

	} else {
		sandboxEndpoints.setSMSReceiptSubscriptions(endpoint);
		...
		smsResponse=me.subscribeToReceiptNotifications(destinationAddress, notifyURL, criteria, notificationFormat, clientCorrelator, callbackData);	
	}
%>
...
<div id="content">
	...
	<%@ include file="mainmenu.inc" %>
		...
		<form method="post" action="smssubscribemessagereceipts.jsp">
