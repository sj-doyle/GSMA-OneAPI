...
<%
	...
	if (submit==null) {
		...
		username="Fred.Jones";
		password="1234";
		endpoint=sandboxEndpoints.getServiceEndpoints().getCancelSMSReceiptSubscriptionEndpoint();
	...
	<%@ include file="mainmenu.inc" %>
        ...
        <div id="other-main">
          ...
          <div class="other-bottom">
            <div class="left">
          <h3>
            Inbound SMS API - Cancel SMS Receipt Notifications Subscription
          </h3>
          <p>
      
		</p>
		
		<form method="post" action="smsstopsubscriptionmessagereceipts.jsp">
