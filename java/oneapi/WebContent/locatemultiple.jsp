...
<%
	...
	if (submit==null) {
		...
		String[] address={address0, address1, address2, address3, address4};
		
		locationResponse=me.locateMultipleTerminals(address, requestedAccuracy);
...
<div id="content">
	...
	<%@ include file="mainmenu.inc" %>
		...
		<form method="post" action="locatemultiple.jsp">
