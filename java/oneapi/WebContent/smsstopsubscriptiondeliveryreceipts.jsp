...
<%
	...
	if (submit==null) {
		...
		username="Fred.Jones";
		password="1234";
		endpoint=sandboxEndpoints.getServiceEndpoints().getCancelSMSDeliverySubscriptionEndpoint();

	} else {
		sandboxEndpoints.setCancelSMSDeliverySubscription(endpoint);
...
<div id="content">
	...
	<%@ include file="mainmenu.inc" %>
		...
		<form method="post" action="smsstopsubscriptiondeliveryreceipts.jsp">
