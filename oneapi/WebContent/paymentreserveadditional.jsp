...
<%
	...
	if (submit==null) {
		...
		username="Fred.Jones";
		password="1234";
		endpoint=sandboxEndpoints.getServiceEndpoints().getAmountReserveAdditionalEndpoint();


	} else {
		sandboxEndpoints.setAmountReserveAdditional(endpoint);
	...
	<%@ include file="mainmenu.inc" %>
        ...
        <div id="other-main">
          ...
          <div class="other-bottom">
            <div class="left">
          <h3>
            Payment API - Reserve Additional Charge On End User's Bill
          </h3>
          <p>
      
		</p>
		
		<form method="post" action="paymentreserveadditional.jsp">
