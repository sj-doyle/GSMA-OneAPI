...
/**
 * The full response from the OneAPI server for a request to subscribe to received MMS Message Receipts
 */
public class MMSMessageReceiptSubscriptionResponse implements java.io.Serializable {
	private static final long serialVersionUID = -1075057031677539254L;
	...
	/**
	 * return resourceReference - a URL uniquely identifying a successful request to create the MMS message receipt subscription
	 */
	public ResourceReference getResourceReference() { return resourceReference; }
	/**
	 * set resourceReference, the URL uniquely identifying a successful request to create the MMS message receipt subscription. This is called internally to set the contents according to the JSON response.
	 * @param resourceReference
	 */
	public void setResourceReference(ResourceReference resourceReference) { this.resourceReference=resourceReference; } 

	/** 
	 * generate a textual representation of the MMSMessageReceiptSubscriptionResponse instance including all nested elements and classes 
	 */
