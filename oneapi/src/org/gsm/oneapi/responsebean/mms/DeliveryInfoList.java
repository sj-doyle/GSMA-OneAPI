...
/**
 * Contains the detail of a request to obtain delivery information for MMS messages sent via the OneAPI server
 */
public class DeliveryInfoList implements java.io.Serializable {
	private static final long serialVersionUID = 9214265875910218116L;
