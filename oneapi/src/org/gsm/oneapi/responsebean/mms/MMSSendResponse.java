...
/**
 * The full response from the OneAPI server for a request to send an MMS Messgage
 */
public class MMSSendResponse implements java.io.Serializable {
	...
	/**
	 * return resourceReference - a URL uniquely identifying a successful request to send an MMS message
	 */
	public ResourceReference getResourceReference() { return resourceReference; }
	/**
	 * set resourceReference, the URL uniquely identifying a successful request to send an MMS message. This is called internally to set the contents according to the JSON response.
	 * @param resourceReference
	 */
	public void setResourceReference(ResourceReference resourceReference) { this.resourceReference=resourceReference; }

	/** 
	 * generate a textual representation of the MMSSendResponse instance including all nested elements and classes 
	 */
